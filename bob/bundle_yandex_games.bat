...
java -jar bob/bob.jar --settings bob/settings/release_game.project_settings --settings bob/settings/yandex_games_game.project_settings --archive --with-symbols --variant release --platform=js-web --bo bob/releases/yandex_games clean resolve build bundle
